...
public final class IntObjectHashtable 
{
	...
	public IntObjectHashtable(int initialCapacity) 
	{
		this(initialCapacity, 0.75f);
	}

	public IntObjectHashtable(int initialCapacity, float fLoadFactor) 
	{
