 ...
 */
public final class GridCellHashtable 
{
	...
	public GridCellHashtable(int initialCapacity) 
	{
		this(initialCapacity, 0.75f);
	}

	public GridCellHashtable(int initialCapacity, float fLoadFactor) 
	{
	...
	public GridCell put(int key, GridCell value) 
	{
	...
	public GridCell remove(int key) 
	{
		Entry tab[] = table;
