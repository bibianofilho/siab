...
/**
 * This class implements a hashtable mapping integer values to GridCellAttributes objects.
 * It´s the same as waba.util.IntHashtable, except that values are 
 * GridCellAttributess, not integers. 
 * 
 * @author Virgilio Alexandre Fornazin
 */
public final class GridCellAttributesHashtable 
{
	private static class Entry 
	{
		int key;
		GridCellAttributes value;
		Entry next;
	}
	...
	public GridCellAttributesHashtable(int initialCapacity) 
	{
		this(initialCapacity, 0.75f);
	}

	public GridCellAttributesHashtable(int initialCapacity, float fLoadFactor) 
	{
	...
	public GridCellAttributes get(int key)
	{
	...
	public GridCellAttributes put(int key, GridCellAttributes value) 
	{
		...
		for (Entry e = tab[index] ; e != null ; e = e.next)
		{
			if (e.key == key) 
			{
				GridCellAttributes old = e.value;
				e.value = value;
	...
	public GridCellAttributes remove(int key) 
	{
		Entry tab[] = table;
