...
/**
 * This class is a grid cell editor for decimal numbers.
 * 
 * @author Virgilio Alexandre Fornazin (mailto:virgiliofornazin@gmail.com)
 */
public class GridCellDecimalEditor extends GridCellEditor
{
	public boolean onStartEdit(Grid grid, GridCell cell, GridCellID cellID, Rect cellRect, Color clrForeColor, Color clrBackColor, Font cellFont, int chrCode)
	{
		...
		GridCellDecimalEditorCtrl edit = new GridCellDecimalEditorCtrl();
		...
		edit.setPrecision(((GridCellDecimal) cell).m_iPrecision);
		edit.setDecimals(((GridCellDecimal) cell).m_iDecimals);
		edit.setDouble(((GridCellDecimal) cell).getDouble(), 
				((GridCellDecimal) cell).m_iPrecision, 
				((GridCellDecimal) cell).m_iDecimals);
	...
	public boolean onEndEdit()
	{
		...
		GridCellDecimalEditorCtrl edit = (GridCellDecimalEditorCtrl) m_EditControl;

		((GridCellDecimal) m_EditCell).setDouble(edit.getDouble());
